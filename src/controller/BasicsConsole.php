...
use normphpCore\layuiAdmin\model\account\AccountModel;
use normphpCore\layuiAdmin\model\console\PersonShortcutModel;
use normphpCore\layuiAdmin\model\console\PersonShortcutTypeModel;
